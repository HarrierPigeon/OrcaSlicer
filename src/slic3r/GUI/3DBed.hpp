...
private:
    ...
    GLModel m_slicing_arrow;
    GLModel m_gravity_arrow;
    GLModel m_plate_normal_arrow;
    Axes m_axes;
...
private:
    ...
    void render_direction_arrows(const Transform3d& view_matrix, const Transform3d& projection_matrix);
    void render_single_arrow(const Vec3d& dir, const ColorRGBA& color, GLModel& model,
