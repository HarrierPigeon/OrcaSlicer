...
void TabPrinter::build_fff()
{
    ...
    auto optgroup = page->new_optgroup(L("Printable space"), "param_printable_space");
        ...
        optgroup->append_single_option_line("slicing_direction");
        optgroup->append_single_option_line("gravity_direction");
        optgroup->append_single_option_line("build_plate_normal");
